...
<div align="center" style="margin-top: 100px">
    ...
    <button id="subjectmanual" class="btn btn-success btn-lg">ajouter un cours</button>
</div>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 id="popupHead">Ajouter un cours</h2>
        </div>
        <div class="modal-body" id="EnterSubject">
            ...
            <div style="display:none" id="addSubjectForm">
                <form action="addsubjectFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="subjectsemester">semaine</label>
