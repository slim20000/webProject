...
<form action="generatetimetable.php" method="post">
    <div align="center" style="margin-top: 100px">
        <select name="select_teacher" class="list-group-item">
            <option selected disabled>choisir un entraineur</option>
            <?php
        ...
        <button type="submit" id="viewteacher" class="btn btn-success btn-lg" style="margin-top: 5px">PLANNING
        </button>
    </div>
</form>
<form action="generatetimetable.php" method="post">
    <div align="center" style="margin-top: 20px">
        <select name="select_semester" class="list-group-item">
            <option selected disabled>choisir la semaine</option>
        ...
        <button type="submit" id="viewsemester" class="btn btn-success btn-lg" style="margin-top: 5px">PLANNING
        </button>
    </div>
</form>
<script>
