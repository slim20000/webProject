...
<div align="center"
     style="margin-top:10%">
    <button
        id="classroommanual" class="btn btn-success btn-lg">ajouter une salle
    </button>
</div>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h2 id="popupHead">ajouter une salle</h2>
        </div>
            ...
            <div style="display:none" id="addClassroomForm">
                <form action="addclassroomFormValidation.php" method="POST">
                    <div class="form-group">
                        <label for="classroomname">NOM</label>
...
<div align="center">
    ...
    <table id=classroomstable>
        <caption><strong>LISTES DES SALLES</strong></caption>
        <tr>
