    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse move-me">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="addteachers.php">ajouter un entraineur</a></li>
                <li><a href="addsubjects.php">ajouter un cours</a></li>
                <li><a href="addclassrooms.php">ajouter une salle</a></li>
              
                <li><a href="generatetimetable.php">planning</a></li>
...
<div align="center" style="margin-top:200px">
    <button id="teachermanual" class="btn btn-success btn-lg">ajouter un entraineur</button>
</div>
        ...
        <div class="modal-body" id="EnterTeacher">
            ...
            <div style="display:none" id="addTeacherForm">
                <form action="addteacherFormValidation.php" method="POST">
                    ...
                    <div class="form-group">
                        <label for="TF">No</label>
                        <input type="text" class="form-control" id="facultyno" name="TF" placeholder="No t004...">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="designation" name="TD">
                            ...
                            <option value="Professor">entraîneur</option>
...
<div>
    ...
    <table id=teacherstable style="margin-left: 80px">
        <caption><strong>information des entraineurs </strong></caption>
        <tr>
            <th width="130">No</th>
